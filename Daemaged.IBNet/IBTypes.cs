...
namespace Daemaged.IBNet
{
  ...
  public class ScannerSubscription
  {
    ...
    {
      CouponRateBelow = Double.MaxValue;
      CouponRateAbove = Double.MaxValue;
      MarketCapBelow = Double.MaxValue;
      MarketCapAbove = Double.MaxValue;
      AverageOptionVolumeAbove = Int32.MaxValue;
      AboveVolume = Int32.MaxValue;
      BelowPrice = Double.MaxValue;
      AbovePrice = Double.MaxValue;
      NumberOfRows = -1;
    }
