...
namespace Daemaged.IBNet
{
  public interface ITWSEncoding
  {
    ...
    void BeginDecodeMessage();
    void EndDecodeMessage();
    ClientMessage DecodeClientMessage();

    void BeginEncodeMessage();
    void EndEncodeMessage();
    void Encode(ServerMessage value);
